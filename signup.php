                    ...
                    <form action="" method="post">
                        ...
                        <div class="row">
                            <div class="col-md-4 col-sm-12">
                                <input type="tel" class="form-control" placeholder="Phone No." name="phoneNo"
                                    required />
                            </div>
                        ...
                        {                        
                            ...
                            VALUES ('$_POST[firstName]','$_POST[lastName]','$_POST[email]','$_POST[password]','$_POST[phoneNo]','$_POST[city]','$_POST[state]')";
                            $cEmail = $_POST["email"];
                            $duplicate = mysqli_query($conn,"Select * from customerinfo where cemail = '$cEmail'");
